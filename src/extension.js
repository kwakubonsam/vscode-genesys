...
const {initializeWorkspaceState, getNotificationDetailsMap} = require('./workspaceState')
...
function activate(context) {
  ...
  let notificationsTreeViewDataProvider = new NotificationsTreeDataProvider(context)
